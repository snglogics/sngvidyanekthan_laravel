                ...
                <div class="col d-flex">
                    <div class="book-card w-100">
                        ...
                        <div class="book-footer d-flex justify-content-between align-items-center">
                            <a href="{{ route('magazines.show', $magazine->id) }}" class="read-button text-decoration-none"
                                title="Read">
                                <i class="bi bi-book"></i>
                            </a>
                            <a href="{{ route('magazines.download', $magazine->id) }}"
                                class="download-button text-decoration-none" title="Download">
