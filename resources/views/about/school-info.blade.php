        ...
        <div class="row g-4">
            @php
                $infos = [
                    ...
                    ['PRINCIPAL', 'Ms. Aswathy N', 'fa-user-tie'],
                    ['PRINCIPAL\'S CONTACT', '7994573586', 'fa-phone'],
                    ['PRINCIPAL\'S EMAIL', 'aluvasvidya@gmail.com', 'fa-envelope'],
                    ['SCHOOL PHONE', '0484-2632102', 'fa-phone-volume'],
                    ['SCHOOL EMAIL', 'aluvasvidya@gmail.com', 'fa-envelope-open'],
