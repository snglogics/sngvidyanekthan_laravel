                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6">
                        <div class="footer-link mt-40">
                            ...
                            <ul>
                                ...
                                <li><a href="{{ route('events.list') }}"><i class="fa fa-angle-right"></i>Event</a>
                                </li>
                            </ul>
                            <ul>
                                <li><a href="{{ route('gallery.list') }}"><i class="fa fa-angle-right"></i>Gallery</a>
                                </li>
                        ...
                        <div class="footer-address mt-40">
                            ...
                            <ul>
                                <li>
                                    ...
                                    <div class="cont">
                                        <p>Valmiki Hills, Thottumughom, Aluva.</p>
                                    </div>
                                </li>
                                <li>
                                    <div class="icon">
