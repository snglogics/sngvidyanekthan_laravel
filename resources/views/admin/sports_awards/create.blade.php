    ...
    <div class="form-container">
        ...
        <form action="{{ route('admin.sports_awards.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-3 input-icon">
                ...
                <input type="text" name="award_year" id="award_year" class="form-control" placeholder="Ex: 2025" required>
            </div>

            <div class="mb-3 input-icon">
                <label for="description" class="form-label"><i class="fas fa-align-left me-1"></i> Description</label>
                <textarea name="description" id="description" class="form-control" rows="4" placeholder="Write a brief description..."></textarea>
            </div>
