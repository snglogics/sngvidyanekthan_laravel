...
<style>
  .input-group .remove-subject { white-space: nowrap; }
</style>
@endsection
...
<div class="container my-5">
  <div class="card shadow-sm p-4">
    ...
    <form action="{{ route('admin.academic_performances.store') }}"
          method="POST"
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  try {
    ...
    container.innerHTML = '';
    Object.entries(old).forEach(([subj, mark]) => addRow({subject: subj, mark}));
    syncJSON();
  } catch {}
});
</script>
