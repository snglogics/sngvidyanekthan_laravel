...
<div class="container py-5">
    <h2 class="text-center mb-5 fw-bold text-primary">Facilities Dashboard</h2>
    <div class="row g-4 justify-content-center homepage-buttons">

        @php
            $buttons = [
                ['route' => 'live-classes.create', 'label' => 'Live Class', 'icon' => 'fas fa-images', 'color' => 'primary'],
                ['route' => 'admin.magazines.index', 'label' => 'Upload magazine', 'icon' => 'fas fa-user-tie', 'color' => 'success'],
