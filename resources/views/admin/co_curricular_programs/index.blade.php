...
<div class="container py-5">
    ...
    <!-- Program Create Form -->
    <form action="{{ route('admin.co_curricular_programs.store') }}" method="POST" enctype="multipart/form-data" class="bg-light p-4 rounded shadow-sm mb-5">
        @csrf

        <div class="mb-3">
            <label for="name" class="form-label fw-semibold"><i class="bi bi-bookmark-fill me-1"></i>Program Name</label>
        ...
        <div class="mb-3">
            <label for="description" class="form-label fw-semibold"><i class="bi bi-pencil-square me-1"></i>Description</label>
            <textarea name="description" class="form-control" rows="4" placeholder="Write a short description..." required></textarea>
        </div>

        <div class="mb-3">
            <label for="image" class="form-label fw-semibold"><i class="bi bi-image-fill me-1"></i>Program Image</label>
            ...
            <div class="card shadow-sm rounded-4 border-0 h-100 hover-shadow">
                ...
                <div class="card-body d-flex flex-column">
                    ...
                    <div class="d-flex gap-2 mt-3">
                        <a href="{{ route('admin.co_curricular_programs.edit', $program->id) }}" class="btn btn-outline-warning btn-sm w-50">
                            <i class="bi bi-pencil-square me-1"></i>Edit
                        </a>
                        <form action="{{ route('admin.co_curricular_programs.destroy', $program->id) }}" method="POST" onsubmit="return confirm('Are you sure you want to delete this program?')" class="w-50">
                            @csrf
                            @method('DELETE')
