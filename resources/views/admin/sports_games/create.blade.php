        ...
        <div class="form-section">
            ...
            <form action="{{ route('admin.sports_games.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="category" class="form-control" placeholder="e.g. Indoor, Outdoor, Team Game"
                        required>
                </div>
                ...
                <button type="submit" id="submitButton" class="btn btn-primary w-100 mt-3">
