    ...
    <div class="container py-4">
        <div class="card shadow rounded">
            ...
            <div class="card-body">
                ...
                <form action="{{ route('admin.academic-calendars.update', $academicCalendar->id) }}" method="POST"
                    ...
                    {{-- Day (Description) --}}
                    <div class="mb-3">
                        <label class="form-label"><i class="bi bi-chat-left-text me-1"></i> Day</label>
                        <textarea name="description" class="form-control" rows="3" placeholder="eg: Saturday">{{ $academicCalendar->description }}</textarea>
                    </div>
                    ...
                    {{-- Month --}}
                    <div class="mb-3">
                        <label class="form-label"><i class="bi bi-tag me-1"></i> Month</label>
                        <input type="text" name="event_type" class="form-control" placeholder="e.g., January, February"
                    ...
                    <div class="mb-3">
                        ...
                        @if ($academicCalendar->attachment)
                            <div class="mt-2">
                                <a href="{{ asset('storage/' . $academicCalendar->attachment) }}" target="_blank"
