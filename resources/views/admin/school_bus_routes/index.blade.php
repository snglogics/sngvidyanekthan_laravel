                            ...
                            <tbody>
                                @foreach ($routes as $route)
                                    <tr>
                                        ...
                                        <td class="text-end">
                                            <a href="{{ route('admin.school_bus_routes.show', $route->id) }}"
                                                class="btn btn-sm btn-info me-1">
                                                <i class="fas fa-eye"></i>
                                            </a>
                                            <a href="{{ route('admin.school_bus_routes.edit', $route->id) }}"
                                                class="btn btn-sm btn-warning me-1">
                                                <i class="fas fa-edit"></i>
                                            </a>
                                            <form action="{{ route('admin.school_bus_routes.destroy', $route->id) }}"
