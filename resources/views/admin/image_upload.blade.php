            ...
            <form id="uploadForm" action="{{ route('image.upload') }}" method="POST" enctype="multipart/form-data"
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="imageName" name="imageName"
                        placeholder="Enter principal name" required value="{{ old('imageName') }}">
                    @error('imageName')
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="imageHeader" name="imageHeader"
                        placeholder="Enter image header" value="{{ old('imageHeader') }}">
                    @error('imageHeader')
                        <div class="text-danger small">{{ $message }}</div>
                    @enderror
                </div>
