        ...
        <div class="card-body">
            <form action="{{ route('teachers.store') }}" method="POST" enctype="multipart/form-data" id="teacherForm">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="designation" class="form-control" placeholder="Assistant Professor" required>
                </div>
                ...
                <button id="submitBtn" class="btn btn-success w-100 mt-3" type="submit" data-bs-toggle="tooltip" title="Click to save teacher info">
