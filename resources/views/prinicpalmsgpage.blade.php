    ...
    <div class="card p-4 my-4 shadow-lg border-0" style="max-width: 1100px; margin: auto;">
        <div class="row g-4 align-items-center">
            ...
            <div class="col-md-4 text-center">
                <img src="{{ asset($principalMsg->image_url) }}" alt="Principal" class="img-fluid rounded-3 shadow"
            ...
            <div class="col-md-8">
                ...
                <p id="principal-message" class="text-muted" style="max-height: 250px; overflow-y: scroll;">
                    {!! nl2br(e($principalMsg->image_description)) !!}
                </p>
            ...
            <div class="row g-4 align-items-center">
                ...
                <!-- Left: Image + Name -->
                <div class="col-md-4 text-center">
                    <img src="{{ asset($managerMsg->image_url) }}" alt="Principal" class="img-fluid rounded-3 shadow"
                        style="max-height: 300px; object-fit: cover;">
                ...
                <div class="col-md-8">
                    ...
                    <p id="manager-message" class="text-muted" style="max-height: 250px; overflow-y: scroll;">
                        {{ $managerMsg->description }}
                    </p>
                    <button id="mntoggle-button" class="btn btn-outline-primary mt-2" onclick="mngrtoggleMessage()">Read
                        more</button>
                </div>
