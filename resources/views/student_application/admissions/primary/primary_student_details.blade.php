...
<style>
  @media print {
    ...
    #printSection { position:absolute; top:0; left:0; width:100%; padding:8px; font-size:10px; }
    .row { display:flex; flex-wrap:wrap; margin:0; }
    .field-block { width:32%; margin-right:1%; margin-bottom:6px; }
...
<div id="printSection" class="py-5">
  <div class="card shadow-lg p-5">
    <div class="text-center mb-4">
      <h2 class="fw-bold text-primary">SREENARAYANA VIDYANIKETAN</h2>
